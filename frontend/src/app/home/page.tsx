        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <section className="mb-14">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-semibold text-black/80 mb-2">Current Traffic Alerts</h2>
              <p className="text-black/50">Stay informed about road conditions in your area</p>
            </div>
          ...
          {/* Quick Stats */}
          <section className="m-2" aria-label="Platform statistics">
